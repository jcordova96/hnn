...
<p> George Mason University's History News Network (HNN) features articles and excerpts by historians from both the
    ...
    aim is to present a wide mix of views. <a href="http://hnn.us/articles/820.html#mission">Click here to read our
...
<p>Half a dozen interns and readers of HNN are responsible for the fascinating list of stories featured every day on
    the <a href="http://hnn.us/roundup/41.html">Breaking News</a> page, which allows readers to keep track of both
...
<p>Our homepage features the original articles published weekly by HNN contributors. They are divided into <a
        href="http://hnn.us/articles/13807.html">categories</a> so readers can easily follow particular subjects of
    concern. Major categories include: News at Home, News Abroad, Historians &amp; History, Education, and Culture
    Watch.</p>

<p>Our most popular department -- and our biggest -- is <a href="http://hnn.us/articles/6975.html">Roundup</a>,
    which is divided into a number of subdepartments and includes excerpts from articles from around the Web. In our
    Friday <a href="http://lists.drizzle.com/mailman/listinfo/hnn-news">newsletter</a> we list the Top 10 excerpts,
    but these comprise just a brief sampling of the extensive collection of excerpts we post every week.</p>

<p>The <a href="http://hnn.us/articles/6976.html">Features department</a> lists services we provide: lists of
    interviews with historians, great history quotes, highlights from the AHA &amp; OAH conventions, and the like.
    The <a href="http://hnn.us/roundup/36.html">Books department</a> displays reviews by HNN's book editors as well
    as excerpts from reviews of books that relate history and current events . (Every month HNN features a Book of
    the Month .)</p>

<p> HNN features two departments that address the specific needs of <a href="http://hnn.us/articles/855.html">
        students</a>&nbsp;and teachers(<a href="http://hnn.us/teachers_edition/grades_3_to_6.html"> grade school </a>
    and&nbsp;<a href="http://hnn.us/teachers_edition/grades_9_to_12.html"> high school </a>).&nbsp;</p>
...
<p> Flagrant violators of <a href="http://hnn.us/articles/1885.html"> HNN's standards</a> will be banned.
...
<p> The <a href="http://hnn.us/roundup/41.html"> Breaking News page </a> features news stories reported in the
    ...
    Europe . <a href="http://hnn.us/articles/6364.html"> Click here </a> to view the lists of media sources HNN
...
<p><a href="http://hnn.us/articles/9749.html">Click here</a> to read about intern responsibilities.</p>
...
<p> HNN publishes original pieces on our homepage . Because HNN encourages the wide dissemination of information,
    all of our content is licensed under <a href="http://creativecommons.org/licenses/by/3.0/"> Creative Commons
...
<p> But as the website evolved we added various features that we thought our readers would find interesting and
    useful . The most popular feature has turned out to be <a href="http://hnn.us/articles/1203.html"> ROUNDUP</a>
...
<p>Sounds complicated. It's not . Just download one of the RSS readers listed below . Then add a channel for each
    ...
    everything else in the column . (Look for the bright blue button that says RSS .) The RSS Feeds for the <a
        href="http://hnn.us/roundup/41.html"> Breaking News </a> page are located at the top .</p>
...
<p> PC:<br><a href="http://www.sharpreader.net"> http://www.sharpreader.net/</a><br><a
        href="http://www.rssreader.org">http://www.rssreader.org/</a><br><br> Mac:<br><a
        href="http://ranchero.com/netnewswire/">http://ranchero.com/netnewswire/</a><br><br> Linux:<br><a
        href="http://www.nongnu.org/straw">http://www.nongnu.org/straw/</a><br><br> Once you have installed an RSS
    reader, add a new channel and use this link: <a href="http://hnn.us/rss.xml">http://hnn.us/rss.xml</a><br><br>
    If you would like to find other sites that syndicate their content through RSS check out: <a
        href="http://www.syndic8.com">http://www.syndic8.com</a>.</p>
